            ...
            <section className="">
              ...
              <section className="defaultPadding">
                <h2 className="title homePageGreeting">
                  <span className="has-text-danger">Hello</span> {this.props.authUser.displayName ? this.props.authUser.displayName.split(' ')[0] :<span>Northcoder. <a href="https://github.com/settings/profile" className=" has-text-weight-light is-italic is-size-7">Set your display name on Github.</a></span>}
                </h2>
